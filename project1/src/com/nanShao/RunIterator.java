...
public class RunIterator implements Iterator {
    ...
    public int[] next() {
        ...
        result[1] = node.getRed();
        result[2] = node.getGreen();
        result[3] = node.getBlue();
        result[0] = node.getTimes();
        node = node.getNext();
        return result;
    }
    ...
    //return the node's red value
    public short getRed(){
        return (short) node.getRed();
    }

    //return the node's green value
    public short getGreen(){
        return (short) node.getGreen();
    }

    //return the node's blue value
    public short getBlue(){
        return (short) node.getBlue();
    }
    ...
    //set node's prev
    public void setPrev(DlinkedListNode n){
        node.setPrev(n);
    }

    //set node's next
    public void setNext(DlinkedListNode node1){
        this.node.setNext(node1);
    }

    //get this.node
    public DlinkedListNode getNode(){
        return this.node;
    }
}