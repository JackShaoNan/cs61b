...
public class SList {
    ...
    public void squish() {
        ...
        SListNode flag1 = head, flag2 = head;
        while(flag1 != null && flag1.next != null){
            while(flag2.next != null && flag2.item.equals(flag2.next.item)){
                flag2 = flag2.next;
                size--;
            }
    ...
    public void twin() {
        ...
        SListNode twinNode = head;
        if(twinNode != null){
            do{
                SListNode newNode = new SListNode(twinNode.item, twinNode.next);
                twinNode.next = newNode;
                twinNode = newNode.next;
            }while(twinNode!=null);
        }
    }
