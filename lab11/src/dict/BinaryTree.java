...
public class BinaryTree implements Dictionary {
    ...
    public Entry remove(Object key) {
        BinaryTreeNode removeMe = findHelper((Comparable)key, root);
        if(removeMe==null)
            return null;
        Entry res = removeMe.entry;
        if(removeMe.leftChild==null && removeMe.rightChild==null){
            //has no child
            if(removeMe==root){
                root = null;
            }else if(removeMe.parent.leftChild==removeMe){
                removeMe.parent.leftChild = null;
            }else{
                removeMe.parent.rightChild = null;
            }
        }else if(removeMe.leftChild!=null && removeMe.rightChild==null){
            //has left child
            if(removeMe==root){
                root = removeMe.leftChild;
                removeMe.leftChild.parent = null;
            }else {
                if(removeMe.parent.leftChild==removeMe)
                    removeMe.parent.leftChild = removeMe.leftChild;
                else
                    removeMe.parent.rightChild = removeMe.leftChild;
                removeMe.leftChild.parent = removeMe.parent;
            }
        }else if(removeMe.rightChild!=null && removeMe.leftChild==null){
            //has right child
            if(removeMe==root){
                root = removeMe.rightChild;
                removeMe.rightChild.parent = null;
            }else {
                if(removeMe.parent.leftChild==removeMe)
                    removeMe.parent.leftChild = removeMe.rightChild;
                else
                    removeMe.parent.rightChild = removeMe.rightChild;
                removeMe.rightChild.parent = removeMe.parent;
            }
        }else{
            //has two kids and find the successor
            BinaryTreeNode cur = removeMe.rightChild;
            while(cur!=null){
            ...
            if(cur == removeMe.rightChild){
                removeMe.rightChild = cur.rightChild;
            ...
            if(removeMe==root){
                ...
                root.leftChild.parent = cur;
                root.rightChild.parent = cur;
                cur.parent = null;
                root = cur;
            }else {
                cur.leftChild = removeMe.leftChild;
                cur.rightChild = removeMe.rightChild;
                if(removeMe.parent.leftChild==removeMe)
                    removeMe.parent.leftChild = cur;
                else
                    removeMe.parent.rightChild = cur;
                cur.parent = removeMe.parent;
            }
        }
        size--;
        return res;
...
//        while(cur != null){
//            //found it
//            if(((Comparable)key).compareTo(cur.entry.key()) == 0){
//                res = cur.entry;
//                //if it is root
//                if(pre == cur){
//                    BinaryTreeNode temp = removeHelper(cur);
//                    if(temp != cur){
//                        temp.leftChild = cur.leftChild;
//                        temp.rightChild = cur.rightChild;
//                        if(cur.rightChild!=null)
//                            cur.rightChild.parent = temp;
//                        if(cur.leftChild!=null)
//                            cur.leftChild.parent = temp;
//                    }else {
//                        temp = null;
//                    }
//                    root = temp;
...
//                        pre.leftChild = removeHelper(cur);
//                        if(pre.leftChild != cur){
...
//                        pre.rightChild = removeHelper(cur);
...
//                    }
//                }
//            }else if(((Comparable)key).compareTo(cur.entry.key()) < 0){
//                pre = cur;
//                cur = cur.leftChild;
//            }else {
//                pre = cur;
...
//        return null;
//    }
//    //find the successor or qianqu of node
////    private BinaryTreeNode removeHelper(BinaryTreeNode node){
...
////                break;
////        }
////        if(node.rightChild == cur && cur==null){
////            //right child is null, we should find qianqu from left
////            cur = node.leftChild;
////            isLeft = true;
////            while(cur!=null){
////                if(cur.leftChild!=null && cur.rightChild!=null){
...
////                    break;
////            }
////            if(node.leftChild==cur && cur==null){
////                //left child is null, this tree will be empty
////                return node;
////            }else {
////                if(isLeft){
...
////            }
////        }else {
////            //find the node cur we want remove
////            if(isLeft){
